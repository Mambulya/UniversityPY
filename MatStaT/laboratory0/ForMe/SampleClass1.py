...
class Sample:
    ...
    def get_frequency(self):
        """
        ищет частоту уникальных элементов среди оригинальной выборги
        :return:
        """
        if self.data is None:
            self.create_data()
    ...
    def draw_frequency_histogram(self, Xlabel="Значения выборги", Ylabel="Количество", diagram_name="Частотная гистограмма",
    ...
    def draw_possibility_histogram(self, Xlabel="Значения выборги", Ylabel="Вероятность", diagram_name="Вероятностная гистограмма",
